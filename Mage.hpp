...
*/
    Mage(const std::string& name, const std::string& race, int vitality = 0, int armor = 0, int level = 0, bool enemy = false, const std::string& magic = "NONE", const std::string& weapon = "NONE", bool incarnate = false);
