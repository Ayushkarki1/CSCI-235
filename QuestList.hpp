...
/*Implement the Quest struct in QuestList.hpp but outside of the QuestList class definition, as follows:
-The Quest struct should consist of the following data members. Please use the following variable names for testing purpose.
...
/*The Quest struct must also define the following:
...
*/
    ...
    Quest(const std::string& title, const std::string description = "NOT DISCOVERED", bool completed = false, int experience_points = 0,
           std::vector<Quest*> dependencies = {}, std::vector<Quest*> subquests = {}): 
           title_(title), description_(description), completed_(completed), experience_points_(experience_points), dependencies_(dependencies), subquests_(subquests){}
};
...
//Unique Methods:
    ...
    */
    int getPosOf(const std::string& quest);
    ...
    */
    bool contains(const std::string& quest);
    ...
    */
    ...
    @return: True if the quest was added or updated successfully, False otherwise
    */
    bool addQuest(const std::string& title, const std::string& description,const bool& complete, const int& exp,const std::vector<Quest*>& dependencies,const std::vector<Quest*>& subquest);
    ...
    */
    int calculateProjectedExperience(Quest* x);
    ...
    */
    int calculatePathwayExperience(Quest* x);
    ...
    */
    void printQuestDetails(Quest* x);
    void printSubquestsRecursive( Quest* quest, int number);
};
